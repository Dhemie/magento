...
abstract class Mage_Core_Model_Resource_Db_Abstract extends Mage_Core_Model_Resource_Abstract
{
     ...
     */
    protected function _setMainTable($mainTable, $idFieldName = null) //main table comes in "tablename/tablename"
    {
        $mainTableArr = explode('/', $mainTable); //get the two strings seperated by /

        if (!empty($mainTableArr[1])) { //no second string after slash
